...
The cheapest fatal test described in the root README's Next steps section is whether a free
prior — historical phase × indication base rates, plus an Open Targets genetic-association score —
is already as good as anything the physics can add. These are those priors, behind a common
